...
const { getEmpleadosXEmpresa, insertEmpleado, deleetEmpleado, crearEmpleadoNuevo, getEmpleadoSolicitudes, allowEmployed, searchEmpleado, upadteEmpleado } = require("../controller/empleadoController");
...
router.post("/search/", [validarJWt], searchEmpleado);
router.put("/updateempleado", [validarJWt], upadteEmpleado);
